...
var scopedClassMaker = function (prefix) {
    return function (classNameSting) {
        var newClassNameString = '';
        classNameSting.split(' ').forEach(function (item) {
            newClassNameString += [prefix, item].filter(Boolean).join('-') + " ";
        });
        return newClassNameString.trim();
    };
};
var sc = scopedClassMaker('lab');
...
var Button = function (_a) {
    ...
    return (react.createElement("button", __assign({ type: "button", className: sc(['storybook-button', "storybook-button--".concat(size), mode].join(' ')), style: { backgroundColor: backgroundColor } }, props), label));
};

var Header = function (_a) {
    var user = _a.user, onLogin = _a.onLogin, onLogout = _a.onLogout, onCreateAccount = _a.onCreateAccount;
    return (react.createElement("header", null,
        react.createElement("div", { className: sc("wrapper") },
            ...
            react.createElement("div", null, user ? (react.createElement(react.Fragment, null,
                react.createElement("span", { className: sc("welcome") },
                    "Welcome, ",
